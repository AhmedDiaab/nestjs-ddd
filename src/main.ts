...
async function bootstrap() {
    ...
    // before RequestContextMiddleware (a Nest middleware, wired later in the pipeline once
    // routing starts), so it resolves its own request id rather than reading one from the
    // request context.
