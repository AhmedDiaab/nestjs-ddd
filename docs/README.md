...
| Task                                                                           | Read                                                                              |
| ------------------------------------------------------------------------------ | --------------------------------------------------------------------------------- |
| Start here if you are new to NestJS, to DDD, or to this template               | [Onboarding](onboarding.md)                                                       |
...
| Make a `POST` safe for a client to retry                                       | [Make an endpoint idempotent](guides/make-an-endpoint-idempotent.md)              |
